                                        ...
                                        <div class="new-product">
                                            <div class="single-product-item">
                                                <div class="product-image">
                                                    ...
                                                    <a href="/frontend/#" class="new-mark-box">new</a>
                                        ...
                                        <div class="new-product">
                                            <div class="single-product-item">
                                                <div class="product-image">
                                                    ...
                                                    <a href="/frontend/#" class="new-mark-box">sale!</a>
                                                    <div class="overlay-content">
                                                        <ul>
                                                            <li><a href="/frontend/#" title="Quick view"><i class="fa fa-search"></i></a></li>
                                                            <li><a href="/frontend/#" title="Quick view"><i class="fa fa-shopping-cart"></i></a></li>
            ...
            <div class="add-two-by-one-column">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
                    <div class="tow-column-add zoom-img">
                        <a href="/frontend/#"><img src="/frontend/img/product/shope-add1.jpg" alt="shope-add" /></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                    <div class="one-column-add zoom-img">
                        <a href="/frontend/#"><img src="/frontend/img/product/shope-add2.jpg" alt="shope-add" /></a>
                    </div>
                </div>
            </div>
                ...
                <div class="tab-bg-product-area">
                                ...
                                <div class="item">
                                    <div class="single-product-item">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <a href="/frontend/single-product.html">Short Sleeves T-shirt</a>
                                            <div class="price-box">
                                                <span class="price">$16.51</span>
                                            </div>
                                        </div>
                    ...
                    <div class="tab-carousel-menu">
                        <ul class="nav nav-tabs product-bg-nav">
                            <li class="active"><a href="/frontend/#women-tab" data-toggle="tab">Women</a></li>
                            <li><a href="/frontend/#tops-tab" data-toggle="tab">tops</a></li>
                            <li><a href="/frontend/#t-shirts" data-toggle="tab">t-shirts</a></li>
                        </ul>
                    </div>
                    <!-- TABS MENU END-->
                </div>
